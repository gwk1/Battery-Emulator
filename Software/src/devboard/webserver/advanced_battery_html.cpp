...
String advanced_battery_processor(const String& var) {
  if (var == "X") {
    ...
    content +=
        "<h4>Balancing setPoint: " + String(datalayer_extended.bmwphevcsc.balance_target_mV) +" mV</h4>" +
    ...
    !defined(MEB_BATTERY) && !defined(BMW_PHEV_CSC_BATTERY)  //Only the listed types have extra info
